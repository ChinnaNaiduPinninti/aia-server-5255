...
<TABLE border="0" cellspacing="1" width="100%">
	<TR>
		<TD colspan="4" class="menusection-Deployer" id="prName1">%value projectName% &gt; Define 
		</TD>
	</TR>
...
%endcomment%
		...
		%endif%
			...
			<TR>
				<TD colspan="5">
							<form name="moveAssetsForm" id="moveAssetsForm" action="/invoke/DevOpsUi.v2.services:moveAssets" target="hidden" method ="post">
								<input type="hidden"  name="projectName" value=%value projectName%>
							<button id="moveAssets">Move Assets</button>
							</form>
